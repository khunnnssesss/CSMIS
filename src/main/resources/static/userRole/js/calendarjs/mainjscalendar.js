...
// console.log('toooo oooo ooo oo oo o oo; dkfajfk ');
...
//       // swal({
//       //   title: 'Register Updated Successful!! user type is  '+userRole,
...
//       //   else if(userRole == 'ADMIN') window.location.replace('/user/dashboard')
//       // })
