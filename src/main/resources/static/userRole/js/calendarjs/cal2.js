...
console.log('a clanendar',adcalendar);
...
console.log('testing tiesotjeo jgong',document.querySelector('#mycalmodal'));
console.log('plain js : ',$('#mycalmodal'));
...
console.log("emp data to send to backend : : ",empData);
})
...
$('#mycalmodal').on('shown.bs.modal', function () {
  ...
  console.log('in calendar func',emailElement);
})
